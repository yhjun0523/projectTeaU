                ...
                <div class="body-content">
                  ...
                  <div class="body-contentbox">
                    ...
                    <p>
                      ...
                      <p>
                        팥 안에는 사포닌과 칼륨 성분이 풍부하게 들어있어 부종의 가장 큰 원인인 나트륨을 몸 밖으로 쉽게 배출 시켜준다. 몸매 관리를 열심히 하는 걸그룹 멤버들이 팥차와 팥물을 즐겨 먹는다고 알려져 주목을 받기도 했다. </p>
                    ...
                    <p>
                      생강은 바이러스와 싸우는 항산화 물질로 가득 차 있어 면역력을 키우고 감기 바이러스를 예방하는데 좋은 음식이다. 목에 좋은 꿀과 비타민C가 풍부한 레몬과 함께 레몬 생강청을 만들어 따뜻한 물에 타 먹으면 맛도 좋고 면역력도 높일 수 있다. </p>
