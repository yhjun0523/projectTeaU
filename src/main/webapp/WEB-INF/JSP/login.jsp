...
<meta name="google-signin-client_id"
	content="748380225556-7n3mpu6kh2k970bk633cgk7rrumbo130.apps.googleusercontent.com">
<title>contact</title>
	...
	<main class="login">
		...
		<section class="login sec_ptb_120" style="padding-top: 200px;">
			<div id="logreg-forms">
				...
				<h1 class="font-weight-normal" style="text-align: center">Log
					In</h1>
				<br>
				...
				<form action="loginView.do" method="POST">
					...
					<input type="password" id="inputPassword" name="memberPass"
						class="form-control" placeholder="비밀번호를 입력하세요" required />

					<div style="text-align: center;">
						<input value="로그인" id="disable" class="btn btn-success btn-block"
							type="submit"
				...
				<div style="text-align: center;">
					...
					<form action="kakaoLogin.do">
						...
						<div>
							<button type="button" onclick="location.href='signup.do'"
								class="btn btn-primary btn-block"
								style="background-color: #fd6c44; font-size: large;"
